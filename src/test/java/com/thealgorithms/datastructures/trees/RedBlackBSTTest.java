...
class RedBlackBSTTest {
    ...
    class EmptyTreeTests {
        ...
        @Test
        @DisplayName("treeMinimum on empty tree root returns nil")
    ...
    @Nested
    @DisplayName("Print tree operations")
    class PrintTreeTests {

        @Test
        @DisplayName("printTree outputs inorder traversal with color and parent info")
        void testPrintTreeInorder() throws Exception {
            insert(10);
            insert(5);
            insert(15);

            Method printTreeMethod = RedBlackBST.class.getDeclaredMethod("printTree", Class.forName("com.thealgorithms.datastructures.trees.RedBlackBST$Node"));
            ...
            try {
                printTreeMethod.invoke(tree, root);
            } finally {
                System.setOut(oldOut);
            }

            String output = baos.toString();
            assertThat(output).contains("Key: 5");
            assertThat(output).contains("Key: 10");
            assertThat(output).contains("Key: 15");
        ...
        @Test
        @DisplayName("printTree on nil node produces no output")
        void testPrintTreeOnNil() throws Exception {
            Method printTreeMethod = RedBlackBST.class.getDeclaredMethod("printTree", Class.forName("com.thealgorithms.datastructures.trees.RedBlackBST$Node"));
            printTreeMethod.setAccessible(true);
            ...
            System.setOut(new PrintStream(baos));
            try {
                printTreeMethod.invoke(tree, nil);
            } finally {
                System.setOut(oldOut);
            }
        ...
        @Test
        @DisplayName("printTreepre outputs preorder traversal with color and parent info")
        void testPrintTreeprePreorder() throws Exception {
            insert(10);
            insert(5);
            insert(15);

            Method printTreepreMethod = RedBlackBST.class.getDeclaredMethod("printTreepre", Class.forName("com.thealgorithms.datastructures.trees.RedBlackBST$Node"));
            ...
            System.setOut(new PrintStream(baos));
            try {
                printTreepreMethod.invoke(tree, root);
            } finally {
                System.setOut(oldOut);
            }
        ...
        @Test
        @DisplayName("printTreepre on nil node produces no output")
        void testPrintTreepreOnNil() throws Exception {
            Method printTreepreMethod = RedBlackBST.class.getDeclaredMethod("printTreepre", Class.forName("com.thealgorithms.datastructures.trees.RedBlackBST$Node"));
            printTreepreMethod.setAccessible(true);
            ...
            System.setOut(new PrintStream(baos));
            try {
                printTreepreMethod.invoke(tree, nil);
            } finally {
                System.setOut(oldOut);
            }
    ...
    @Nested
    @DisplayName("Delete fixup specific branches")
    class DeleteFixupBranchTests {

        @Test
        @DisplayName("Delete triggers fixup case where sibling is red (left side)")
        void testDeleteFixupSiblingRedLeft() throws Exception {
            insert(10);
            insert(5);
            insert(20);
            insert(1);
            ...
            assertThat(delete(1)).isTrue();
            assertRedBlackInvariants();
        }

        @Test
        @DisplayName("Delete triggers fixup case where sibling is red (right side)")
        void testDeleteFixupSiblingRedRight() throws Exception {
            insert(20);
            insert(10);
            insert(30);
            insert(5);
            ...
            assertThat(delete(35)).isTrue();
            assertRedBlackInvariants();
        }

        @Test
        @DisplayName("Delete triggers fixup case where sibling children are black")
        void testDeleteFixupSiblingChildrenBlack() throws Exception {
            insert(10);
            insert(5);
            insert(20);
            insert(1);
            ...
            assertThat(delete(1)).isTrue();
            assertThat(delete(7)).isTrue();
            assertRedBlackInvariants();
        }

        @Test
        @DisplayName("Delete triggers fixup case where sibling left child is red")
        void testDeleteFixupSiblingLeftChildRed() throws Exception {
            insert(20);
            insert(10);
            insert(30);
            insert(5);
            ...
            assertThat(delete(25)).isTrue();
            assertThat(delete(35)).isTrue();
            assertRedBlackInvariants();
        }

        @Test
        @DisplayName("Delete triggers fixup case where sibling right child is red")
        void testDeleteFixupSiblingRightChildRed() throws Exception {
            insert(10);
            insert(5);
            insert(20);
            insert(1);
        ...
        @Test
        @DisplayName("Delete node with two children uses successor transplant")
        void testDeleteNodeWithTwoChildren() throws Exception {
            insert(50);
            insert(30);
            insert(70);
            insert(20);
            ...
            assertThat(delete(30)).isTrue();
            assertThat(find(30)).isNull();
            assertThat(inorderKeys()).containsExactly(20, 35, 40, 45, 50, 60, 70, 80);
            assertRedBlackInvariants();
        }

        @Test
        @DisplayName("Delete node whose successor is its right child")
        void testDeleteNodeSuccessorIsRightChild() throws Exception {
            insert(10);
            insert(5);
            insert(20);
            insert(15);
            ...
            assertThat(delete(10)).isTrue();
            assertThat(find(10)).isNull();
            assertThat(inorderKeys()).containsExactly(5, 15, 20);
            assertRedBlackInvariants();
        }
    }

    @Nested
    @DisplayName("FixTree specific branches")
    class FixTreeBranchTests {

        @Test
        @DisplayName("Color flip when both parent and uncle are red (left uncle)")
        void testColorFlipLeftUncle() throws Exception {
            insert(20);
            insert(10);
            insert(30);
            insert(5);
        ...
        @Test
        @DisplayName("Color flip when both parent and uncle are red (right uncle)")
        void testColorFlipRightUncle() throws Exception {
            insert(20);
            insert(10);
            insert(30);
            insert(5);
        ...
        @Test
        @DisplayName("Left-left case in fixTree (parent is left child, node is left child)")
        void testFixTreeLeftLeftCase() throws Exception {
            insert(30);
            insert(20);
            insert(10);
        ...
        @Test
        @DisplayName("Right-right case in fixTree (parent is right child, node is right child)")
        void testFixTreeRightRightCase() throws Exception {
            insert(10);
            insert(20);
            insert(30);
    ...
    @Nested
    @DisplayName("FindNode boundary conditions")
    class FindNodeBoundaryTests {

        @Test
        @DisplayName("findNode returns null when key is less than root but no left child")
        void testFindNodeKeyLessNoLeftChild() throws Exception {
            insert(20);
        ...
        @Test
        @DisplayName("findNode returns null when key is greater than root but no right child")
        void testFindNodeKeyGreaterNoRightChild() throws Exception {
            insert(20);
        ...
        @Test
        @DisplayName("findNode returns null when key is between two nodes with no matching child")
        void testFindNodeKeyBetweenNodes() throws Exception {
            insert(20);
            insert(10);
            insert(30);
            ...
            assertThat(find(5)).isNull();
            assertThat(find(15)).isNull();
            assertThat(find(25)).isNull();
            assertThat(find(35)).isNull();
        }
    }

    @Nested
    @DisplayName("Demo methods with System.in redirection")
    class DemoMethodTests {

        @Test
        @DisplayName("insertDemo reads keys from stdin and prints tree")
        void testInsertDemo() throws Exception {
            String input = "10\n5\n15\n-999\n";
            ...
            String output = baos.toString();
            assertThat(output).contains("Add items");
            assertThat(output).contains("Key: 5");
            assertThat(output).contains("Key: 10");
            assertThat(output).contains("Key: 15");
            assertThat(output).contains("Pre order");
        }

        @Test
        @DisplayName("deleteDemo deletes existing key and prints tree")
        void testDeleteDemoExistingKey() throws Exception {
            insert(10);
            insert(5);
            insert(15);
            ...
            String output = baos.toString();
            assertThat(output).contains("Delete items");
            assertThat(output).contains("Deleting item 5");
            assertThat(output).contains(": deleted!");
        }

        @Test
        @DisplayName("deleteDemo reports non-existent key")
        void testDeleteDemoNonExistentKey() throws Exception {
            insert(10);
            ...
            String output = baos.toString();
            assertThat(output).contains("Deleting item 99");
